...
plugins=(aws brew github git git-flow dircycle python django osx pip vagrant virtualenvwrapper knife ruby rails gem zsh-syntax-highlighting heroku rvm ssh-agent urltools web-search)
