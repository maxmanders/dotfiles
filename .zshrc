...
export AWS_CLOUDFORMATION_HOME=$AWS_HOME/cli_tools/cloudformation-api-tools
export AWS_RDS_HOME=$AWS_HOME/cli_tools/rds-api-tools
export PATH=$PATH:$EC2_HOME/bin:$AWS_ELB_HOME/bin:$AWS_CLOUDWATCH_HOME/bin:$EC2_AMITOOL_HOME/bin:$AWS_AUTO_SCALING_HOME/bin:$AWS_CLOUDFORMATION_HOME/bin:$AWS_RDS_HOME/bin
